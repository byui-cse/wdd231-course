...
After verifying that your page updated, make sure that you submitted the correct URL in the Microsoft Teams Channel. You shuold have done this in the [course setup activity](../prove/setup)
